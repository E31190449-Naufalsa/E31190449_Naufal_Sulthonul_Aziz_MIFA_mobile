...
//berguna untuk membuat kelas view biodata dengan memwarisi AppCompatActivity
public class ViewBiodata extends AppCompatActivity {
    // berguna untuk memanggil fungsi dari cursor
    protected Cursor cursor;
    // berguna untuk memanggil fungsi dari helper
    DataHelper dbHelper;
    // berguna untuk memanggil fungsi dari button
    Button ton2;
    // berguna untuk memanggil fungsi dari text
    TextView text1, text2, text3, text4, text5;
    @Override
    //berguna untuk membuat function onCreate untuk menampilkan data dari database
